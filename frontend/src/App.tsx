...
const configureAuth0Client = (): Auth0Client => {
  ...
  const auth0Config: Auth0ClientOptions = {
    ...
    loginCallbackUrl: process.env.NODE_ENV === 'production' ? 'tractable-classifier-demo-dev.eu.auth0.com' : window.location.origin,
    logoutRedirectUrl: process.env.NODE_ENV === 'production' ? 'tractable-classifier-demo-dev.eu.auth0.com' : window.location.origin
  };
